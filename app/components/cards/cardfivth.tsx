...
const CardFive = () => {
  return (
    <div className='w-full flex md:flex-row flex-col gap-5 mt-5' >
      ...
      <div className='md:w-[75%] w-[90%] mx-auto h-[270px] border border-green-500 rounded-[30px] p-10' style={{ backgroundColor: '#FFFFFF' }}>
        <div className='flex flex-col gap-6'>
          <h3 className="font-semibold  w-full max-w-[767px] mb-6 text-[18px] leading-[26px] md:text-[23px] md:leading-[30px] xl:text-[29px] xl:leading-[37.8px] flex items-center text-[#2A2A2A]">Interactive support for  <span className="px-1">   </span>   the farme
          </h3>
